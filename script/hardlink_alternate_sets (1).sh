...
cd records/2026/february/week2 || exit 1
...
cd company/reports/2026/march/week3 || exit 1
echo "Sales data" > sales.txt
echo "Summary data" > summary.txt
echo "Before hard link:"
ls -li
...
cd backup/system/2026/april/week4 || exit 1
echo "Config settings" > config.txt
echo "Log entries" > log.txt
echo "Before hard link:"
ls -li
...
cd notes/linux/2026/may/week1 || exit 1
...
cd server/logs/2026/june/week2 || exit 1
